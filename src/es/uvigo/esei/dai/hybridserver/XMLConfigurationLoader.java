...
public class XMLConfigurationLoader {
	public Configuration load(File xmlFile) throws Exception {
		...
		try {
			...
			// Modificamos los campos de la clase Configuracion según los datos leídos
			configuration.setHttpPort(Integer.parseInt(httpNode.getTextContent()));
			configuration.setWebServiceURL(webServiceNode.getTextContent());
			configuration.setNumClients(Integer.parseInt(numClientsNode.getTextContent()));
			configuration.setDbUser(userNode.getTextContent());
			configuration.setDbPassword(passwordNode.getTextContent());
			configuration.setDbURL(urlNode.getTextContent());
			configuration.setServers(serverList);
